...
var or__4047__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5408_SHARP_){
return p1__5408_SHARP_.length();
}),cljs.core.keys(m))));
...
return (function (p__5412){
var vec__5413 = p__5412;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5413,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5413,(1),null);
var len = k.length();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5416_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__5416_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(quil.util.prepare_quil_name(p1__5416_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5417_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__5417_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_Processing$prototype$PConstants,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__5417_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4684__auto___5423 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__4647__auto__ = [];
var len__4641__auto___5424 = arguments.length;
var i__4642__auto___5425 = (0);
while(true){
if((i__4642__auto___5425 < len__4641__auto___5424)){
args__4647__auto__.push((arguments[i__4642__auto___5425]));

var G__5426 = (i__4642__auto___5425 + (1));
i__4642__auto___5425 = G__5426;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5418_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__5418_SHARP_),cljs.core.second(p1__5418_SHARP_));
...
/** @this {Function} */
quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq5419){
var G__5420 = cljs.core.first(seq5419);
var seq5419__$1 = cljs.core.next(seq5419);
var G__5421 = cljs.core.first(seq5419__$1);
var seq5419__$2 = cljs.core.next(seq5419__$1);
var G__5422 = cljs.core.first(seq5419__$2);
var seq5419__$3 = cljs.core.next(seq5419__$2);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5420,G__5421,G__5422,seq5419__$3);
});
