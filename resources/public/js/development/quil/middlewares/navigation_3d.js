...
var vec__2284 = axis;
var a_x = cljs.core.nth.call(null,vec__2284,(0),null);
var a_y = cljs.core.nth.call(null,vec__2284,(1),null);
var a_z = cljs.core.nth.call(null,vec__2284,(2),null);
var vec__2287 = v;
var x = cljs.core.nth.call(null,vec__2287,(0),null);
var y = cljs.core.nth.call(null,vec__2287,(1),null);
var z = cljs.core.nth.call(null,vec__2287,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__2290,p__2291){
var vec__2292 = p__2290;
var u1 = cljs.core.nth.call(null,vec__2292,(0),null);
var u2 = cljs.core.nth.call(null,vec__2292,(1),null);
var u3 = cljs.core.nth.call(null,vec__2292,(2),null);
var vec__2295 = p__2291;
var v1 = cljs.core.nth.call(null,vec__2295,(0),null);
var v2 = cljs.core.nth.call(null,vec__2295,(1),null);
var v3 = cljs.core.nth.call(null,vec__2295,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__2298_SHARP_){
return (p1__2298_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__2299_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__2299_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__2300_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__2300_SHARP_,angle_lr),angle_ud);
...
var map__2302 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__2302__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__2302__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__2304 = cljs.core._EQ_;
var expr__2305 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__2304.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__2305))){
return straight;
} else {
if(cljs.core.truth_(pred__2304.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__2305))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__2304.call(null,quil.middlewares.navigation_3d.space,expr__2305))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__2304.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__2305))){
return up;
} else {
if(cljs.core.truth_(pred__2304.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__2305))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__2304.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__2305))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__2302,map__2302__$1,up,straight){
return (function (p1__2301_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__2301_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__2302,map__2302__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__2307_SHARP_);
});})(initial_state))
);
});
/**
...
var map__2308_2319 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2308_2320__$1 = (((((!((map__2308_2319 == null))))?(((((map__2308_2319.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2308_2319.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2308_2319):map__2308_2319);
var vec__2309_2321 = cljs.core.get.call(null,map__2308_2320__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_2322 = cljs.core.nth.call(null,vec__2309_2321,(0),null);
var c_y_2323 = cljs.core.nth.call(null,vec__2309_2321,(1),null);
var c_z_2324 = cljs.core.nth.call(null,vec__2309_2321,(2),null);
var vec__2312_2325 = cljs.core.get.call(null,map__2308_2320__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_2326 = cljs.core.nth.call(null,vec__2312_2325,(0),null);
var u_y_2327 = cljs.core.nth.call(null,vec__2312_2325,(1),null);
var u_z_2328 = cljs.core.nth.call(null,vec__2312_2325,(2),null);
var vec__2315_2329 = cljs.core.get.call(null,map__2308_2320__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_2330 = cljs.core.nth.call(null,vec__2315_2329,(0),null);
var p_y_2331 = cljs.core.nth.call(null,vec__2315_2329,(1),null);
var p_z_2332 = cljs.core.nth.call(null,vec__2315_2329,(2),null);
quil.core.camera.call(null,p_x_2330,p_y_2331,p_z_2332,(p_x_2330 + c_x_2322),(p_y_2331 + c_y_2323),(p_z_2332 + c_z_2324),u_x_2326,u_y_2327,u_z_2328);
