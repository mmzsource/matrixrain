...
return cljs.core.merge.call(null,initial_state,p1__2277_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_2278 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_2279 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_2278);
var pos_2280 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_2278);
quil.core.scale.call(null,zoom_2279);

var tr__2184__auto___2281 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_2279) - cljs.core.first.call(null,pos_2280)),(((quil.core.height.call(null) / (2)) / zoom_2279) - cljs.core.second.call(null,pos_2280))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__2184__auto___2281);
