...
return (new CustomEvent(event_name,(function (){var obj31797 = {"detail":data};
return obj31797;
})()));
} else {
...
var f = (function (){var pred__31804 = cljs.core._EQ_;
var expr__31805 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31804.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31805))){
return ((function (pred__31804,expr__31805){
return (function (p1__31798_SHARP_){
return console.warn(p1__31798_SHARP_);
});
;})(pred__31804,expr__31805))
} else {
if(cljs.core.truth_(pred__31804.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31805))){
return ((function (pred__31804,expr__31805){
return (function (p1__31799_SHARP_){
return console.debug(p1__31799_SHARP_);
});
;})(pred__31804,expr__31805))
} else {
if(cljs.core.truth_(pred__31804.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31805))){
return ((function (pred__31804,expr__31805){
return (function (p1__31800_SHARP_){
return console.error(p1__31800_SHARP_);
});
;})(pred__31804,expr__31805))
} else {
return ((function (pred__31804,expr__31805){
return (function (p1__31801_SHARP_){
return console.log(p1__31801_SHARP_);
});
;})(pred__31804,expr__31805))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31808){
...
var eval_fn = cljs.core.get.call(null,map__31809__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31811_SHARP_);
});})(new_def))
);
...
return (function (p__31812){
var vec__31813 = p__31812;
var ky = cljs.core.nth.call(null,vec__31813,(0),null);
var v = cljs.core.nth.call(null,vec__31813,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1544906676685
