...
var G__26916 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26916;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26917 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26917,ch);
...
if(("\\" === ch__$1)){
var ch_26918__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26918__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26918__$2);
} else {
}

var G__26919 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26919;
continue;
}
}
...
var vec__26927 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26927,(0),null);
var start_column = cljs.core.nth.call(null,vec__26927,(1),null);
...
var G__26930 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26930;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26931 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26932 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26932;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26931;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26933 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26933,(0),null);
var start_column = cljs.core.nth.call(null,vec__26933,(1),null);
...
var vec__26936 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26936,(0),null);
var end_column = cljs.core.nth.call(null,vec__26936,(1),null);
...
var vec__26939 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26939,(0),null);
var start_column = cljs.core.nth.call(null,vec__26939,(1),null);
...
var vec__26942 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26942,(0),null);
var end_column = cljs.core.nth.call(null,vec__26942,(1),null);
...
var vec__26945 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26945,(0),null);
var start_column = cljs.core.nth.call(null,vec__26945,(1),null);
...
var vec__26948 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26948,(0),null);
var end_column = cljs.core.nth.call(null,vec__26948,(1),null);
...
var sb = (function (){var G__26951 = (new goog.string.StringBuffer());
G__26951.append(initch);
...
var G__26953 = (function (){var G__26952 = sb;
G__26952.append(ch);

return G__26952;
})();
var G__26954 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26953;
ch = G__26954;
continue;
}
...
G__26958.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26958;
})();
var G__26962 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26961;
ch = G__26962;
continue;
...
break;
default:
var G__26963 = (function (){var G__26959 = sb;
G__26959.append(ch);

return G__26959;
})();
var G__26964 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26963;
ch = G__26964;
continue;
...
var vec__26965 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26965,(0),null);
var end_column = cljs.core.nth.call(null,vec__26965,(1),null);
...
var line = cljs.core.nth.call(null,vec__26968,(0),null);
var column = cljs.core.nth.call(null,vec__26968,(1),null);
...
var vec__26973 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26973,(0),null);
var column = cljs.core.nth.call(null,vec__26973,(1),null);
...
var vec__26978 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26978,(0),null);
var column = cljs.core.nth.call(null,vec__26978,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26983 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26983,(0),null);
var start_column = cljs.core.nth.call(null,vec__26983,(1),null);
...
var vec__26986 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26986,(0),null);
var end_column = cljs.core.nth.call(null,vec__26986,(1),null);
...
var G__26989 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26989,true,null,opts,pending_forms);
...
var G__26990 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26990)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26990)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26990)){
...
var _STAR_suppress_read_STAR__orig_val__26991 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26992 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26992;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26991;
}});
...
var G__26993 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26993,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26993,rdr,first_line);
...
var G__26997 = matched;
var G__26998 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26997;
finished = G__26998;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26999 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27000 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27000;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26999;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__27001 = cljs.tools.reader.arg_env;
var arg_env_temp_val__27002 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__27002;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27003 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27003,"(");
...
var G__27004 = (i + (1));
var G__27005 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__27001;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27006 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27006);
...
var G__27007 = cljs.core.next.call(null,s__$1);
var G__27008 = ret;
s__$1 = G__27007;
r = G__27008;
continue;
...
var G__27009 = cljs.core.next.call(null,s);
var G__27010 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27009;
key_vals = G__27010;
continue;
} else {
...
var gensym_env_orig_val__27014 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__27015 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__27015;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__27014;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27016 = token;
var G__27016__$1 = (((G__27016 == null))?null:cljs.core.subs.call(null,G__27016,(1)));
var G__27016__$2 = (((G__27016__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27016__$1));
var G__27016__$3 = (((G__27016__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27016__$2));
var G__27016__$4 = (((G__27016__$3 == null))?null:cljs.core.symbol.call(null,G__27016__$3));
if((G__27016__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27016__$4);
}
})():(function (){var G__27017 = token;
var G__27017__$1 = (((G__27017 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27017));
if((G__27017__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27017__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e27024){if((e27024 instanceof Error)){
var e = e27024;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27028,reader){
...
var eof = cljs.core.get.call(null,map__27029__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
args__4647__auto__.push((arguments[i__4642__auto___27038]));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27035){
var G__27036 = cljs.core.first.call(null,seq27035);
var seq27035__$1 = cljs.core.next.call(null,seq27035);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27036,seq27035__$1);
});


//# sourceMappingURL=reader.js.map?rel=1544906673856
